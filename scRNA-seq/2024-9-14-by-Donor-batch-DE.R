...
all$sample_id <- paste0(all$Donor,"_",all$batch)# batch 8
...
metadata
a <- c("exp1","exp2","exp3","exp4","exp1","exp2","exp3","exp5","exp8","exp7","exp6","exp7","exp7",
       "exp1","exp2","exp3","exp4","exp1","exp2","exp3","exp5","exp8","exp7","exp6","exp7",rep("NA",each = 18))
metadata$batch <- a
...
res_tbl
write.table(res_tbl,"donor_batch_916-cluster1_res_tbl.csv")
padj_cutoff <- 0.05
...
sig_res
# write.csv(sig_res,"2024-9-14-cluster0_by_Donor-mt-60.csv")
...
# Check significant genes output
sig_res
# write.table(sig_res,"2024-9-13-cluster1_euploid_mt_25.csv")