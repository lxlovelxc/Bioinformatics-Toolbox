sample <- read.csv("/home/xi/Desktop/2024-8-20-smart-atac-test2/multiomics-DTN/ATAC/sample_info.csv")

sample <- read.csv("/home/xi/Desktop/2024-8-20-smart-atac-test2/multiomics-Lysis02/ATAC/sample_info.csv")

sample <- read.csv("/home/xi/Desktop/2024-8-20-smart-atac-test2/ATAC-ONLY-DTN-Lysis/sample_info.csv")
sample <- as.data.frame(sample)
View(sample)

sample <- sample[sample$library_size >= 200 & complete.cases(sample), ]
...
# 打开PDF设备
# pdf("multiomics-DTN-ATAC-quality_filtered.pdf")
# 
# pdf("multiomics-Lysis02-ATAC-quality_filtered.pdf")

pdf("ATAC-ONLY-DTN-Lysis-quality_filtered.pdf")
